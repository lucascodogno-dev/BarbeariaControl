...
const ServiceManager = () => {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      showAlert(
        `Serviço "${serviceToDelete.name}" excluído com sucesso!`,
        "success"
      );
  ...
  const validateForm = () => {
    ...
    if (parseInt(formData.duration) < 1 || parseInt(formData.duration) > 180) {
      newErrors.duration = "Duração deve estar entre 1 e 180 minutos";
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editMode && currentId) {
        ...
        showAlert(
          `Serviço "${serviceData.name}" atualizado com sucesso!`,
          "success"
        );
      } else {
        ...
        showAlert(
          `Serviço "${serviceData.name}" adicionado com sucesso!`,
          "success"
        );
      }
        ...
        {loading ? (
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-6 max-w-md mx-auto">
              Você ainda não possui serviços cadastrados. Adicione seu primeiro

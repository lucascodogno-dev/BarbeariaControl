...
//   // Removed unused availableDates state
...
//     // Removed setAvailableDates as availableDates is no longer used
...
//       // Verifica se o dia está disponível (não é final de semana e está no intervalo permitido)
//       const isAvailable = dayOfWeek !== 0 && dayOfWeek !== 6 && date.setHours(0, 0, 0, 0) >= new Date().setHours(0, 0, 0, 0)
// ;
